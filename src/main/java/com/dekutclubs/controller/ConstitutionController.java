...
public class ConstitutionController {
	...
	private String saveDirectory = "C:\\xampp\\tomcat\\webapps\\reports\\constitutions\\";
	@Autowired
	...
	public ModelAndView create(@Valid @ModelAttribute("newConstitution") ConstitutionModel constitution, BindingResult result,
        ...
        //Email address of deans office
		String recipientAddress = "rebecca.nzau@dkut.ac.ke";
		String message = "Hi,A constitution has been sent to you by "+clubName+".Please login to Dekut clubs/societies portal and check it for approval/Disapproval";
		...
		ModelAndView mav = new ModelAndView("newConstitution");
		request.setAttribute("clubname", clubName);
		mav.addObject("successMess", "Your constitution has reached office of the dean of students and is being processed.\n"
				+ "Keep checking your email for updates.Thank you,stay connected.");
		status.setComplete();
		return mav;
	}
	...
	public void doDownload(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String fullPath = "C:\\xampp\\tomcat\\webapps\\reports\\constitutions\\" + url + "";
	...
	public ModelAndView DisApprove(@Valid DisaproveCommentModel disaprove, BindingResult result, SessionStatus status)
		...
		email.setTo(recipientAddress);
		email.setSubject("Dekut Clubs.\n Disapproval details.\n");
		email.setText("Reason(s) for club disapproval:\n" + commentmsg);
