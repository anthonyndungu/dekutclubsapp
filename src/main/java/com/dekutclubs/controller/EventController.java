...
public class EventController
{
   ...
   private String url;
	private String saveDirectory = "C:\\Users\\VINE\\workspace\\DekutClubManager\\events\\";
	@Autowired
	...
	Query qry = sess.createQuery("from EventModel e where e.clubname=:cn");
	...
	public ModelAndView newEventsForm()
	{
	...
	public ModelAndView create(@ModelAttribute("newEvent")EventModel event, BindingResult result, SessionStatus status,
			@RequestParam CommonsMultipartFile[] fileUpload,HttpSession session) throws IllegalStateException, IOException
	{
	...
	public void doDownload(HttpServletRequest request,
		 ...
		 System.out.println("File name is: " +url);
	        ...
	        String fullPath ="C:\\Users\\VINE\\workspace\\DekutClubManager\\events\\"+url+"";      
