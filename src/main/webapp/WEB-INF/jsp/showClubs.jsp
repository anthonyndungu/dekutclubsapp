...
<title>Registered Clubs | DeKUT Clubs Manager</title>
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		<br>
		<form action="searchClubs.do" method="post">
			<div class="panel panel-info">
				<div class="panel-heading">
					<span class="lead">REGISTERED CLUBS</span>&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="table pure-table pure-table-bordered pure-table-striped">
			<tr bgcolor="lightblue">
				<th>CLUB NAME</th>
				<th style="white-space:nowrap;">PATRON</th>
			...
			<c:if test="${! empty SEARCH_CONTACTS_RESULTS_KEY}">
				<c:forEach var="club" items="${SEARCH_CONTACTS_RESULTS_KEY}">
					<tr>
					    <td><c:out value="${club.clubname}"></c:out></td>
					    <td><c:out value="${club.clubpatron}"></c:out></td>
					    <td><c:out value="${club.patronContact}"></c:out></td>
					    <td><c:out value="${club.patronEmail}"></c:out></td>
						<td><c:out value="${club.chairperson}"></c:out></td>
						<td><c:out value="${club.chairpersoncontact}"></c:out></td>
						<td><c:out value="${club.chairpersonemail}"></c:out></td>
						<td><c:out value="${club.meetingvenue}"></c:out></td>
						<td>&nbsp;&nbsp;<a class="btn btn-danger"
							href="javascript:deleteClub('deleteClub.do?clubid=${club.clubid}');"><span
	...
	<nav>
		<ul class="pager">
			...
			<li class="next"><a href="viewDelayedReport.do">Next<span
