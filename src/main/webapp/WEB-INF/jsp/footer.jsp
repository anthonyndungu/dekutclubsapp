		...
		<div class="container text-center container-hr">
			...
			<div class="col-lg-6">
				<ul class="list-block text-left"">
					...
					<li><a href="http://portal.dkut.ac.ke:81/Default.aspx"><font style="color:#fff;">Student
							Portal</font></a><span style="color: #ff0000;"></span></li>
					<li><a href="http://portal.dkut.ac.ke:81/staff/Default.aspx"><font style="color:#fff;">Staff
							Portal</font><sup><span style="color: #ff0000;"></span></sup>
					</a><sup><span style="color: #ff0000;"></span></sup></li>
					<li><a href="http://helpdesk.dkut.ac.ke/user-support/"><font style="color:#fff;">ICT
							Helpdesk</font></a></li>
					<li><a
						href="http://172.16.32.4/oasis/catalog/(S(jfy44wfbztngar55io0z3i55))/default.aspx?session=new&amp;installation=kimathi"><font style="color:#fff;">Library
							Catalogue</font></a></li>
					<li><a href="http://repository.dkut.ac.ke:8080/xmlui/"
						target="_blank"><font style="color:#fff;">Institutional Repository</font></a></li>
					<li><a href="/index.php/newsletters"><font style="color:#fff;">Newsletters</font></a></li>
				</ul>
			</div>
		</div>
		<%--End container--%>
