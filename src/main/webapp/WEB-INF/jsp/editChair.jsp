...
<title>Edit Chair | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container table-danger">
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-3">PROFILE INFORMATION</span>
			</div>
			<form:form action="updateChair.do" method="post"
				commandName="editChair">
				<table class="table ">
					<tr>
						<td>
							<div class="form-group col-md-12">
								<div class="col-md-7">
									...
									<form:input cssClass="form-control" path="regnum"
										readonly="true" />
