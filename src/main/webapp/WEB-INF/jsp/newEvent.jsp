...
<title>Event Registration | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-4">UPLOAD FILES</span>
			</div>
			<center>
				<h4>
			...
			<center>
				<form:form action="saveEvent.do" method="post"
					commandName="newEvent" enctype="multipart/form-data">
					<table class="table" align="center">
						<tr>
							<td align="center"><h3 style="color: red;">Zip all
									files (Pictures and Reports)</h3></td>
						</tr>
						<tr>
							<div class="row">
								<td>
									<div class="form-group col-lg-offset-4">
										<div class="col-md-5">
											<label for="Event Name">Event Name<fonts
						...
						<tr>
							<div class="row">
								<td>
									<div class="form-group col-lg-offset-4">
										<div class="col-md-5">
											<label for="Place Of Event">Place Of Event<font
												style="color: red">*</font></label> <input class="form-control"
												placeholder="Place attended" name="eventPlace" />
						...
						<tr>
							<div class="row">
								<td>
									<div class="form-group col-lg-offset-4">
										<div class="col-md-5">
											<label for="Reports">Reports<font style="color: red">*</font></label>
											<input path="url" class="form-control btn-primary"
						...
						<tr>
							<td colspan="3" align="center"><input class="btn btn-danger"
								...
								type="reset" name="" value="Reset" class="btn btn-warning"></td>
						</tr>
					</table>
				</form:form>
			</center>
		...
		<nav>
			<ul class="pager">
				...
				<li class="next"><a href="saveConstitution.do">Next<span
